...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("catProducts", [
      ...
      {
        imagePath: "/images/orijen.jpg",
        title: "Orijen – Adult Cat & Kitten 5.4 Kg",
        qte: 100,
        price: 1390000,
        description:
          "Loaded with the richly-nourishing meat ingredients all cats need to thrive, ORIJEN’s award-winning low-carbohydrate, low-glycemic formula supports healthy blood sugars for peak health and optimal body weight. \n And with each morsel now infused with freeze-dried meats and liver, ORIJEN cat foods are bursting with natural savory flavors that all cats love. \n Prepared with fresh and local ingredients in our award-winning kitchens, ORIJEN keeps your cat or kitten happy, healthy and strong. Read our ingredients and we think you’ll agree!",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        imagePath: "/images/schesir.jpg",
        title: "Schesir – Tuna with Surimi 85 Gr",
        qte: 100,
        price: 30000,
        description:
          "TTop quality food for adult cats made with 100% natural ingredients, free from added colorings and preservatives. Careful selection of the very best parts of the fish, steam-cooked and hand-processed. In soft jelly.",
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
